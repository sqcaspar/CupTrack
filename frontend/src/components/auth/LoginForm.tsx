...
export const LoginForm: React.FC<LoginFormProps> = ({ onSwitchToRegister }) => {
  ...
  const handleAppleLogin = async () => {
    ...
    console.log('Apple OAuth login initiated');
    // For now, we'll just log this - OAuth implementation would be added later
  };

  const handleDemoLogin = async () => {
    setEmail('demo@cuptrack.com');
    setPassword('demo123');
    await login({ email: 'demo@cuptrack.com', password: 'demo123' });
  };

  return (
    <div className="auth-form-container">
      <form onSubmit={handleSubmit} className="auth-form">
        <h2 className="auth-form-title">Sign in to CupTrack</h2>
        ...
        <button
          ...
          disabled={loading}
        >
          🚀 Try Demo (demo@cuptrack.com)
        </button>

        <div className="demo-hint">
          <p><strong>Demo Credentials:</strong></p>
          <p>Email: <code>demo@cuptrack.com</code></p>
